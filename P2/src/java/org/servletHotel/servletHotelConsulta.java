...
import com.hotelwsoap.HotelWS;

@WebServlet(name = "servletHotelConsulta", urlPatterns = {"/servletHotelConsulta"})
public class servletHotelConsulta extends HttpServlet {

    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8080/HotelWSapplication/HotelWS.wsdl")
    private HotelWS service;
...
"                      </ul>"
    ...
    private int consultaLibres(int idHotel, int fecha) {
        ...
        com.hotelwsoap.HotelWSoap port = service.getHotelWSoapPort();

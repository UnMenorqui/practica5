...
<html>
    <head>
        ...
        <title>Check free flight seats</title>
        ...
        <div class="container">
            <div class="login-box">
                ...
                <div id="Con Rest" class="tabcontent">
                    <form action="http://localhost:8080/VueloRest/webresources/generic/consultaLibres" method="get">
                        <label for="id_vuelo">Id flight</label>
                        <br/>
                        <input type="text" name="id" placeholder="id Flight"/>
                        <br/>
                ...
                <div id="Con Soap" class="tabcontent">
                    <form method="POST" action="http://localhost:8080/P2/servletVueloConsulta">
                         <label for="id_vuelo">Id flight</label>
                        <br/>
                        <input type="text" name="id" placeholder="id Flight"/>
                        <br/>

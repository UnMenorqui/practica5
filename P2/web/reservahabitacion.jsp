        ...
        <div class="container">
            <div class="login-box">
                ...
                <div id="Con Rest" class="tabcontent">
                    <form action="http://localhost:8080/HotelRest/webresources/generic/reservarHab" method="post">
                ...
                <div id="Con Soap" class="tabcontent">
                    <form method="POST" action="http://localhost:8080/P2/servletHotelReserva">
                         <label for="id_vuelo">Id Hotel</label>
                        <br/>
                        <input type="text" name="id" placeholder="id Hotel"/>
                        <br/>
